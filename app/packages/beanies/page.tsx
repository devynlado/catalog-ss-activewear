...
import { EmbroideryPackageBuilder, beaniesConfig, beaniesPageConfig } from '@/components/packages/embroidery';

export const dynamic = 'force-dynamic';

export const metadata: Metadata = {
  title: 'Custom Embroidered Beanies - All-Inclusive Pricing | Garment Decor',
  description: 'Get custom embroidered beanies from $11.95/beanie at 100+. All-inclusive pricing includes embroidery, digitizing, and pre-production sample. Mix colors at no extra charge. 10-day turnaround.',
  openGraph: {
    title: 'Custom Embroidered Beanies - All-Inclusive Pricing',
    description: 'From $11.95/beanie at 100+. Includes embroidery, digitizing & sample. Mix colors free.',
    type: 'website',
  },
};

const { hero, whatsIncluded, benefits, faq, stickyMobileCta, productStyleId } = beaniesPageConfig;

export default async function BeaniesPage() {
      ...
      <section className="py-16 bg-gradient-to-b from-stone-100 to-[#FAF6F3]">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-stone-600 mb-6">
            Get a free quote with mockup of your logo on the beanie. No obligation.
          </p>
          <a
            href="/quote"
