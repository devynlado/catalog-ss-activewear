...
export function ShippingForm({ orderId }: ShippingFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div>
        <label htmlFor="actual-shipping-cost" className="mb-1 block text-xs font-medium text-slate-600">
        ...
        <p className="mt-0.5 text-[11px] text-slate-400">What you paid the carrier — can update later</p>
      </div>
