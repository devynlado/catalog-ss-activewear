...
const whyChooseReasons = [
  {
    icon: Thermometer,
    title: 'Properly Cured Silk Screen Prints',
    description: 'Every silk screen print cured at 320–330°F. No cracking, peeling, or fading — the difference between hobby work and true commercial silk screen printing.',
  },
  {
    icon: Shield,
    title: 'Premium Plastisol Inks',
    description: 'The foundation of high-quality silk screen printing. Vibrant, wash-resistant colors that last hundreds of cycles without fading.',
  },
  {
    icon: DollarSign,
    title: 'Factory-Direct Pricing',
    description: 'Local silk screen printing rates that beat broker shops. No middleman — price breaks at 75, 100, 250, 500, and 1,000+ pieces.',
  },
  {
    icon: Sparkles,
    title: 'Custom Silk Screen Print Effects',
    description: 'Puff, metallic, glitter, glow-in-the-dark, and more specialty inks for custom silk screen prints that stand out from the rack.',
  },
  {
    icon: Palette,
    title: 'PMS Color Matching',
    description: 'Exact Pantone matching on every silk screen printing order — perfect brand consistency from your first run to your hundredth.',
  },
  {
    icon: Check,
    title: 'Quality Guaranteed',
    description: 'Every shirt inspected before it ships. We stand behind every custom silk screen printing job we deliver — 100%.',
  },
];
...
export default function SilkScreenPrintingLP() {
  const scrollToForm = () => {
  ...
  return (
    <div className="min-h-screen pb-20 lg:pb-0">
      ...
      <LPHero
        ...
        headline="Custom Silk Screen Printing in Southern California"
        subheadline="Local silk screen printing for brands, businesses, and teams — factory-direct pricing, same week turnaround available, 50 piece minimum. Vibrant, durable custom silk screen t-shirts that hold up wash after wash."
      />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-2 text-slate-600">
              1 color, 1 location • Volume discounts on every custom screen printing order
            </p>
          </motion.div>
      ...
      <section className="relative py-12 lg:py-16 bg-gradient-to-b from-white to-stone-50/50 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl font-bold text-navy-800 sm:text-3xl">
              Why Choose Us for Silk Screen Printing
            </h2>
            <p className="mt-2 text-slate-600">
              A trusted local screen printing company serving brands across Southern California
            </p>
          </motion.div>
      ...
      <section className="py-12 lg:py-16 bg-navy-800">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold text-white sm:text-3xl">
            Looking for Silk Screen Printing Near You?
          </h2>
          <p className="mt-4 text-lg text-slate-300">
            Local silk screen printing and commercial runs, all under one roof in Southern California. Get a free quote within 2 hours. 50 piece minimum.
          </p>
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="tel:+18559427636"
              onClick={() => trackPhoneClick({ source: 'lp_silk_screen_printing_final_cta' })}
