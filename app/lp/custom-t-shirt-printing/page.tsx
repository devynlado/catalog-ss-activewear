...
const whyChooseReasons = [
  {
    ...
    description: 'Every shirt cured at 320–330°F. No cracking, peeling, or fading — the difference between hobby work and professional t-shirt printing.',
  },
  {
    icon: Shield,
    title: 'Premium Plastisol Inks',
    description: 'Vibrant colors that withstand hundreds of washes without fading. The same quality trusted by streetwear brands and Fortune 500 teams.',
  },
  {
    icon: DollarSign,
    title: 'Factory-Direct Pricing',
    description: 'Wholesale shirt printing rates that beat broker shops. No middleman — price breaks at 75, 100, 250, 500, and 1,000+ pieces.',
  },
  {
    icon: Sparkles,
    title: 'Special Effects Available',
    description: 'Puff, metallic, glitter, glow-in-dark, and more specialty inks for custom t-shirts printing that stand out from the rack.',
  },
  {
    icon: Palette,
    title: 'PMS Color Matching',
    description: 'Exact Pantone matching for perfect brand consistency on every t-shirt printing order — from your first run to your hundredth.',
  },
  {
    icon: Check,
    title: 'Quality Guaranteed',
    description: 'Every shirt inspected before it ships. We stand behind our work the way few shirt printing companies do — 100%.',
  },
];
...
export default function CustomTShirtPrintingLP() {
  const scrollToForm = () => {
  ...
  return (
    <div className="min-h-screen pb-20 lg:pb-0">
      ...
      <LPHero
        ...
        subheadline="Wholesale shirt screen printing for brands, businesses, and teams — factory-direct pricing, same week turnaround available, 50 piece minimum. Vibrant, durable prints that last."
      />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-2 text-slate-600">
              1 color, 1 location • Volume discounts on every screen printing order
            </p>
          </motion.div>
      ...
      <section className="relative py-12 lg:py-16 bg-gradient-to-b from-white to-stone-50/50 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl font-bold text-navy-800 sm:text-3xl">
              Why Choose Us for Custom T-Shirt Printing
            </h2>
            <p className="mt-2 text-slate-600">
      ...
      <section className="py-12 lg:py-16 bg-navy-800">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold text-white sm:text-3xl">
            Looking for Custom T-Shirt Printing Near You?
          </h2>
          <p className="mt-4 text-lg text-slate-300">
            Local custom t-shirt screen printing under one roof in Southern California. Get a free quote within 2 hours. 50 piece minimum.
          </p>
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="tel:+18559427636"
              onClick={() => trackPhoneClick({ source: 'lp_custom_t_shirt_printing_final_cta' })}
