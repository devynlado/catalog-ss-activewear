...
const whyChooseReasons = [
  {
    ...
    description: 'Every t-shirt cured at 320-330°F for a smooth, durable finish. No cracking, peeling, or fading — guaranteed.',
  },
  {
    icon: Shield,
    title: 'Premium Plastisol Inks',
    description: 'Vibrant, wash-resistant colors on every shirt. Our inks withstand hundreds of cycles without fading.',
  },
  {
    icon: DollarSign,
    title: 'Factory Direct Pricing',
    description: 'No middleman. Price breaks at 75, 100, 250, 500, and 1,000+ pieces for your t-shirt order.',
  },
  {
    icon: Sparkles,
    title: 'Full Shirt Coverage',
    description: 'Front, back, sleeves, or all-over prints. Specialty inks available — puff, metallic, glitter, and more.',
  },
  {
    icon: Palette,
    title: 'PMS Color Matching',
    description: 'Exact Pantone matching so your brand colors look perfect on every single shirt.',
  },
  {
    icon: Check,
    title: 'Quality Guaranteed',
    description: 'Every printed tee inspected before it ships. We stand behind our work 100%.',
  },
];
...
export default function TshirtScreenPrintingLP() {
  const scrollToForm = () => {
  ...
  return (
    <div className="min-h-screen pb-20 lg:pb-0">
      ...
      <LPHero
        ...
        headline="Custom T-Shirt Screen Printing"
        subheadline="High quality screen prints for shirts — factory-direct pricing, same week turnaround available, 50 piece minimum. Order custom screen prints that look and feel professional."
      />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-2 text-slate-600">
              1 color, 1 location • Volume discounts that reward bigger orders
            </p>
          </motion.div>
          ...
          <div className="text-center mt-8">
            ...
            <p className="text-sm text-slate-500 mt-3">
              * Pricing varies by colors, print locations, and garment brand. We&apos;ll provide an exact quote.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-12 lg:py-16 bg-gradient-to-b from-white to-stone-50/50 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl font-bold text-navy-800 sm:text-3xl">
              Why Brands Choose Us for T-Shirt Screen Printing
            </h2>
            <p className="mt-2 text-slate-600">
              Trusted by businesses across Southern California for high quality screen prints
            </p>
          </motion.div>
      ...
      <section className="py-12 lg:py-16 bg-navy-800">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold text-white sm:text-3xl">
            Ready to Order Custom Screen Printed T-Shirts?
          </h2>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              onClick={() => trackPhoneClick({ source: 'lp_tshirt_screen_printing_final_cta' })}
