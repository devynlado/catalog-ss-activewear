...
const whyChooseReasons = [
  {
    ...
    description: 'Every print cured at 320-330°F. No cracking, peeling, or fading — guaranteed.',
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description: 'Puff, metallic, glitter, glow-in-dark, and more specialty inks.',
  },
  {
    icon: Palette,
    title: 'PMS Color Matching',
    description: 'Exact Pantone matching for perfect brand consistency.',
  },
  {
    icon: Check,
...
export default function ScreenPrintingLP() {
  const scrollToForm = () => {
  ...
  return (
    <div className="min-h-screen pb-20 lg:pb-0">
      ...
      <LPHero
        ...
        subheadline="Factory-direct pricing, same week turnaround available, 50 piece minimum. Get vibrant, durable prints that last."
      />
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              onClick={() => trackPhoneClick({ source: 'lp_screen_printing_final_cta' })}
