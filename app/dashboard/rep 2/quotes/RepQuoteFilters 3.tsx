...
interface RepQuoteFiltersProps {
...
export function RepQuoteFilters({ currentStatus, currentSearch, statusCounts }: RepQuoteFiltersProps) {
  ...
  const updateParams = (updates: Record<string, string | undefined>) => {
    ...
    router.push(`/dashboard/rep/quotes?${params.toString()}`);
  };
