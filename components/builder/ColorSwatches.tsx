      ...
      {shouldShowSearch && (
        <div className="relative mb-3">
          ...
          <input
            ...
            className="w-full pl-9 pr-9 py-2 text-sm rounded-lg border border-slate-200 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 focus:outline-none"
          />
          {searchQuery && (
            <button
